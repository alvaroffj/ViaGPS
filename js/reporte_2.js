...
//    $filtros.slideUp();
    switch(reporteSel) {
        case 0:
            $dataReporte = $("<table id='dataReporte' border='0' cellspacing='0' cellpadding='0' width='100%' class='table table-striped'><thead><tr><th>Fecha</th><th>Distancia</th><th>Velocidad</th></tr></thead></table>");
            break;
        case 1:
            $dataReporte = $("<table id='dataReporte' border='0' cellspacing='0' cellpadding='0' width='100%' class='table table-striped'><thead><tr><th>Fecha</th><th>Veh&iacute;culo</th><th>Patente</th><th>Alarma</th><th>Regla</th></tr></thead></table>");
            break;
        case 2:
            break;
        case 3:
            $dataReporte = $("<table id='dataReporte' border='0' cellspacing='0' cellpadding='0' width='100%' class='table table-striped'><thead><tr><th>Fecha</th><th>Veh&iacute;culo</th><th>Patente</th><th>Velocidad</th></tr></thead></table>");
            break;
    }
